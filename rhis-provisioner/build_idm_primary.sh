...
echo "Using rhis-builder-idm to build IdM Primary from inventory"
GREEN='\033[0;32m'
...
usage() {
            echo "Usage: build_idm_primary.sh [options]"
            echo "This helper script launches the play to install and configure the RHIS IdM Primary"
            echo "Options:"
