...
echo "Using rhis-builder-kvm to configure kvm_hypervisors from inventory"
GREEN='\033[0;32m'
...
usage() {
            echo "Usage: build_kvm_hosts.sh [options]"
            echo "This helper script launches the play to install and configure kvm hypervisors for use as a Satellite compute resource"
            echo "Options:"
            ...
            echo "NOTE: This will install a new kvm instance or configure an existing one for use as a Satellite compute resource"
