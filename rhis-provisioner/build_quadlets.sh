...
echo "Using rhis-builder-quadlet-deploy to provision quadlets to quadlet hosts in inventory"
GREEN='\033[0;32m'
...
usage() {
            echo "Usage: build_quadlets.sh [options]"
            echo "This helper script launches the play to install and configure quadlets to the quadlet servers"
            echo "Options:"
            ...
            echo "NOTE: This containers to as systemd services on the quadlet nodes"
