...
echo "Using Satellite to build AAP hosts defined in list aap24_hosts"
GREEN='\033[0;32m'
...
usage() {
            echo "Usage: deploy_aap24_hosts.sh [options]"
            echo "This helper script launches the play to have Satellite deploy the AAP 2.4 or earlier host instances"
            echo "Options:"
