...
echo "Using Satellite to build Host Group test hosts defined in list hostgroup_test_hosts_rhel10"
...
usage() {
            echo "Usage: deploy_rhel10_test_hosts.sh [options]"
            echo "This helper script launches the play to have Satellite deploy test instances for ALL RHEL10 Hostgroups!"
            echo "Options:"
